...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-red-50 to-orange-50">
        ...
        <div className="max-w-2xl mx-auto">
          <Card className="shadow-lg">
            <CardContent className="p-6 sm:p-8">
              <h3 className="text-xl sm:text-2xl font-bold text-gray-800 mb-6">Order Details</h3>
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <Button
                  ...
                  className="w-full bg-red-600 hover:bg-red-700 text-white py-3 text-base sm:text-lg font-semibold transition-colors duration-300 rounded-md disabled:bg-gray-400 disabled:cursor-not-allowed"
